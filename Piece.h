...
public:
  ...
  virtual void calculatePossibleMove(string source_square, shared_ptr<Piece> board[][BOARD_LENGTH], \
                                     vector<string>& possible_moves) = 0;

  bool isDestinationEmpty(int rank, int file, bool is_white, shared_ptr<Piece> board[][BOARD_LENGTH], \
